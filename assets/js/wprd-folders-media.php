...
class WPRD_FoldersMedia
{
	...
	{
		load_plugin_textdomain('wprd-folders-media', false, dirname( plugin_basename(__FILE__ ) ) . '/languages' );
	...
	{
		register_setting('wrfm-settings', 'wprd-folders-media', [&$this, 'valid_settings']);
	}
	...
	public function admin_scripts()
	{
		add_action('admin_print_scripts-'.$this->hook, function() {
			wp_enqueue_media();
			wp_enqueue_script('wrfm-scripts', plugins_url('media-uploader.js', __FILE__), ['jquery'], filemtime(dirname(__FILE__).'/media-uploader.js'), false);
		});
